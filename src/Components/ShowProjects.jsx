    ...
    <>
      ...
      <div className="md:flex mt-40 md:space-x-10 items-start space-y-6 md:space-y-0">
        <img
          ...
          src="/assets/solar-17.webp"
          alt=""
          onClick={() => openModal("/assets/solar-17.webp")}
        />
        <video
          className="rounded-lg z-40 relative w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-video-4.mp4"
          muted
          loop
          autoPlay
        />
      ...
      <div className="md:flex mt-6 md:space-x-10 items-start space-y-6 md:space-y-0">
        <img
          ...
          alt=""
          onClick={() => openModal("/assets/solar-2.png")}
        />
        <video
          className="rounded-lg z-40 relative w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-video-1.mp4"
          muted
          loop
          autoPlay
        />
      ...
      <div className="md:flex mt-6 md:space-x-10 items-start space-y-6 md:space-y-0">
        <img
          className="relative rounded-lg z-40 w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-11.jpg"
          alt=""
          onClick={() => openModal("/assets/solar-11.jpg")}
        />
        <video
          className="rounded-lg z-40 relative w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-video-2.mp4"
          muted
          loop
          autoPlay
        />
      ...
      <div className="md:flex mt-6 md:space-x-10 items-start space-y-6 md:space-y-0">
        <img
          className="relative rounded-lg z-40 w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-3.png"
          alt=""
          onClick={() => openModal("/assets/solar-3.png")}
        />
        <video
          className="rounded-lg z-40 relative w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-video-3.mp4"
          muted
          loop
          autoPlay
        />
      ...
      <div className="md:flex mt-6 md:space-x-10 items-start space-y-6 md:space-y-0">
        <img
          className="relative rounded-lg z-40 w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-16.webp"
          alt=""
          onClick={() => openModal("/assets/solar-16.webp")}
        />
        <img
          className="relative rounded-lg z-40 w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-5.jpg"
          alt=""
          onClick={() => openModal("/assets/solar-5.jpg")}
        />
      </div>
      <div className="md:flex mt-6 md:space-x-10 items-start space-y-6 md:space-y-0">
        <img
          className="relative rounded-lg z-40 w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-6.jpg"
          alt=""
          onClick={() => openModal("/assets/solar-6.jpg")}
        />
        <img
          className="relative rounded-lg z-40 w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-7.jpg"
          alt=""
          onClick={() => openModal("/assets/solar-7.jpg")}
        />
      </div>
      <div className="md:flex mt-6 md:space-x-10 items-start space-y-6 md:space-y-0">
        <img
          className="relative rounded-lg z-40 w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-8.jpg"
          alt=""
          onClick={() => openModal("/assets/solar-8.jpg")}
        />
        <img
          className="relative rounded-lg z-40 w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-9.jpg"
          alt=""
          onClick={() => openModal("/assets/solar-9.jpg")}
        />
      </div>
      <div className="md:flex mt-6 md:space-x-10 items-start space-y-6 md:space-y-0">
        <img
          className="relative rounded-lg z-40 w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-10.jpg"
          alt=""
          onClick={() => openModal("/assets/solar-10.jpg")}
        />
        <img
          className="relative rounded-lg z-40 w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-12.jpg"
          alt=""
          onClick={() => openModal("/assets/solar-12.jpg")}
        />
      </div>
      <div className="md:flex mt-6 md:space-x-10 items-start space-y-6 md:space-y-0">
        <img
          className="relative rounded-lg z-40 w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-18.webp"
          alt=""
          onClick={() => openModal("/assets/solar-18.webp")}
        />
        <img
          className="relative rounded-lg z-40 w-full md:w-1/2 h-auto md:h-96 object-cover"
          src="/assets/solar-14.webp"
          alt=""
          onClick={() => openModal("/assets/solar-14.webp")}
        />
      </div>
